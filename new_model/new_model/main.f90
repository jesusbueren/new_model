program jmp
    ...
    character::end_key
    real(SP),dimension((parameters_to_est+1)*parameters_to_est)::simplex_v
    real(SP),dimension((parameters_to_est+1),parameters_to_est)::simplex
    ...
    open(unit=9,file='parameters_restricted.txt')
        write(9,*) parameters
    close(9)

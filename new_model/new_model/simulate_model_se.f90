        ...
        do i_l=1,indv
            ...
            do t_l=1,obs
                ...
                if (h_i(i_l,t_l,1) /= -9) then
                    ...
                    beq100_it(PI_q_i(i_l),f_l(2))=beq100_policy(pos_x,h_i(i_l,t_l,1),xi_l,gender_i(i_l),PI_q_i2(i_l),f_l(1),nh_l,generation_i(i_l)+t_l-1)-data_beq100_IC(PI_q_i(i_l),f_l(2))
                else 
                    x_it(t_l+1)=-9.0_sp
                    a_it(t_l+1)=-9.0_sp
                end if
